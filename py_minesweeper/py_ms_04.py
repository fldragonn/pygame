...
# 타일 오픈 확인
CHECKED = [[0 for _ in range(COL_COUNT)] for _ in range(ROW_COUNT)]
...
while running:
    ...
    # 격자 그리기
    for x in range(0, COL_COUNT * CELL_SIZE, CELL_SIZE):
        pygame.draw.line(screen, GRAY_LINE, (x, 0), (x, ROW_COUNT * CELL_SIZE))
    for y in range(0, ROW_COUNT * CELL_SIZE, CELL_SIZE):
